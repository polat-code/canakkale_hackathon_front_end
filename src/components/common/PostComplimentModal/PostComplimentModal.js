...
const PostComplimentModal = ({ postId, show, handleClose }) => {
  ...
  const handleSendCompliment = (e) => {
    e.preventDefault();
    // Burada şikayet gönderme işlemini gerçekleştirin
    console.log("Post ID:", postId);
    console.log("Report Reason:", reportReason);
    console.log("Description:", description);
    // İşlem tamamlandıktan sonra modalı kapatabilirsiniz
    handleClose();
  };
        ...
        <Form onSubmit={handleSendCompliment}>
          ...
          <Form.Group className="mb-3" controlId="reportReason">
            ...
            >
              ...
              <option value="MISINFORMATION">Yanıltıcı ve Yanlış Bilgi</option>
